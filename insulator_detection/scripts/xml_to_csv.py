...
def main():
    ...
    image_path = os.path.join(os.getcwd(), 'XML', 'Training')
    xml_df = xml_to_csv(image_path, SKIP_NEGATIVES)
    xml_df.to_csv('{}_data.csv'.format('Training'), index=None)
    print('Successfully converted xml to csv.')

    image_path = os.path.join(os.getcwd(), 'XML', 'Validation')
    xml_df = xml_to_csv(image_path, SKIP_NEGATIVES)
    xml_df.to_csv('{}_data.csv'.format('Validation'), index=None)
    print('Successfully converted xml to csv.')
